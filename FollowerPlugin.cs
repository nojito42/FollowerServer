...
public class FollowerPlugin : BaseSettingsPlugin<FollowerPluginSettings>
{
    ...
    private void ManageLeaderOnSameMap()
    {
        ...
        if (leaderEntity != null)
        {
            ...
            {
                var opt = GameController.IngameState.IngameUi.ItemsOnGroundLabelElement.FindChildRecursive(e=> e != null && e.IsVisible && e.Text.Contains("opt-in", StringComparison.CurrentCultureIgnoreCase));
